...
static struct FScriptStruct_AkAudio_StaticRegisterNativesFAkPropertyToControl
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAkItemPropertiesConv_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAkItemPropertiesConv_Conv_FAkPropertyToControlToString, "Conv_FAkPropertyToControlToString" }, // 167279189
		{ &Z_Construct_UFunction_UAkItemPropertiesConv_Conv_FAkPropertyToControlToText, "Conv_FAkPropertyToControlToText" }, // 859949794
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAkItemPropertiesConv, 3910741252);
	...
	IMPLEMENT_CLASS(UAkItemProperties, 2751983043);
