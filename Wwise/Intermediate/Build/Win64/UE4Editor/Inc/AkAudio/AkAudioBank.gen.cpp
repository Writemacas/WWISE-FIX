...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FSetPropertyParams Z_Construct_UClass_UAkAudioBank_Statics::NewProp_LinkedAkEvents = { "LinkedAkEvents", nullptr, (EPropertyFlags)0x0014000000022015, UE4CodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAkAudioBank, LinkedAkEvents), METADATA_PARAMS(Z_Construct_UClass_UAkAudioBank_Statics::NewProp_LinkedAkEvents_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAkAudioBank_Statics::NewProp_LinkedAkEvents_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAkAudioBank, 364898317);
